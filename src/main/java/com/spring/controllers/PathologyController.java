...
public class PathologyController {
	...
	public ResponseEntity<radiologistGetResp> getTests(@RequestHeader(name = WebConstants.USER_AUTH_TOKEN) String AUTH_TOKEN,
		...
		if (!Validator.isValidString(AUTH_TOKEN) && jwtutil.checkToken(AUTH_TOKEN, WebConstants.USER_PATHOLOGIST) != null && !Validator.isValidString(id)) {
			try {
	...
	public ResponseEntity<testPostResponse> saveTestReport(@RequestHeader(name = WebConstants.USER_AUTH_TOKEN) String AUTH_TOKEN,
		...
		if (!Validator.isValidString(AUTH_TOKEN) && jwtutil.checkToken(AUTH_TOKEN,WebConstants.USER_PATHOLOGIST) != null && !Validator.isEmptyTestPostRequest(scanReport)) {
			try {
